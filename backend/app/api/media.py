...
def delete_media(media_id: int, db: Session = Depends(get_db)):
    ...
    db.execute(delete(SimilarityMatch).where(SimilarityMatch.media_item_id == media_id))
    db.execute(delete(SimilarityMatch).where(SimilarityMatch.matched_media_item_id == media_id))
    db.flush()
